...
export default function Experience() {
  ...
  const desktopLayout = (
    <Container bg={bg} w={"100%"} maxW={"unset"}>
      <Container maxW={768} pt={"40"} pb={"20"}>
        <Flex
          display={"flex"}
        ...
        <Flex flexDirection={"column"} gap={10} h={"100%"} pt={10}>
          {experiences.map((prop, index) => {
            return (
              <Box
                key={index}
                p={8}
              ...
              >
                <Flex gap={5} justifyContent={"space-between"}>
                  <Flex pr={5} flexDirection={"column"}>
                    <Image
                  ...
                  <Flex flexDirection={"column"} gap={5} maxW={"lg"} flex={1}>
  ...
  const mobileLayout = (
    <Container bg={bg} w={"100%"} pt={"20"} pb={"20"}>
            ...
            >
              <Flex flexDirection={"column"} gap={5}>
                <Image
                  ...
                  maxWidth={45}
                />
                <Flex flexDirection={"column"} gap={5} maxW={"lg"}>
                  <Flex flexDirection={"column"} gap={1}>
                    <Text
                      fontWeight={"extrabold"}
                      color={cardTitleTextColor}
